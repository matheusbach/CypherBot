...
namespace CypherBot.Data // fazendo na classe errada
{
    ...
    {
        public static Dictionary<int, Participante> participantes = new Dictionary<int, Participante>();
        ...
        public static void LoadParticipantesData()
        {
            ...
            {
                participantes = JsonConvert.DeserializeObject<Dictionary<int, Participante>>(File.ReadAllText(Props.dataSorteioPatch));
            }
            dontWriteFile = false;
        }
